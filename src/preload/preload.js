...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  storeGet: (section) => ipcRenderer.invoke('store:get', section),
  storeSet: (section, value) => ipcRenderer.invoke('store:set', section, value),
  storeUpdate: (patch) => ipcRenderer.invoke('store:update', patch),
  storeResetSection: (section) => ipcRenderer.invoke('store:reset-section', section),
  saveShareCardPng: (payload) => ipcRenderer.invoke('share-card:save-png', payload),
  copyShareCardPng: (payload) => ipcRenderer.invoke('share-card:copy-png', payload),
